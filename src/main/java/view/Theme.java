...
import java.awt.*;
public class Theme {
    public static final Color BG = new Color(81,76,73);
    // Nave bar background color
    public static final Color NAV_BG = new Color(81,76,73);
    ...
    public static final Font MEDIUM = new Font("SansSerif", Font.PLAIN, 18);
}
